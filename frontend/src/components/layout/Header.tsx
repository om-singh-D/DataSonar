...
export function Header() {
  ...
  return (
    <header className="fixed top-0 right-0 w-[calc(100%-16rem)] h-16 z-40 bg-surface-container-low/70 backdrop-blur-xl border-b border-outline-variant/15 shadow-sm flex justify-between items-center px-8 font-inter text-sm font-medium">
      <div className="flex flex-1 items-center gap-6">
        ...
        <div className="flex items-center gap-4">
          <Link href="#" className="text-primary border-b-2 border-primary pb-1 transition-opacity">Prod-Cluster-01</Link>
          <Link href="#" className="text-on-surface-variant hover:text-on-surface transition-opacity">Staging</Link>
        </div>
      </div>
      <div className="flex items-center gap-4">
        ...
        <Link href="/anomalies" className="p-2 text-on-surface-variant hover:text-on-surface transition-colors relative block">
